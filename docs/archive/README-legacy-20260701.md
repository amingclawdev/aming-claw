...
> Archived legacy README from 2026-07-01. This page is provenance only; the
> active entrypoint is the root README plus the `aming-claw-onboard` guide.
...
**Plugin packaging deep-dive for contributors**: see the archived note
[`Archive/skills/aming-claw/references/plugin-packaging.md`](../../Archive/skills/aming-claw/references/plugin-packaging.md).
...
- [Plugin Packaging Notes](../../Archive/skills/aming-claw/references/plugin-packaging.md)
