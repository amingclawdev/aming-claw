...
class ExecutorWorker:
    ...
    def _execute_task(self, task: dict) -> dict:
        ...
        context = {
            ...
            "runtime_context_id": metadata.get("runtime_context_id", ""),
            "snapshot_id": metadata.get("snapshot_id", ""),
            "projection_id": metadata.get("projection_id", ""),
            "route_context_hash": metadata.get("route_context_hash", ""),
            "prompt_contract_id": metadata.get("prompt_contract_id", ""),
            "prompt_contract_hash": metadata.get("prompt_contract_hash", ""),
            "route_token_ref": metadata.get("route_token_ref", ""),
            "route_prompt_contract": metadata.get("route_prompt_contract", {}),
