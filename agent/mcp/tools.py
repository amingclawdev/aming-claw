...
def _contract_runtime_bypass_line_schema_properties() -> dict[str, Any]:
    properties = {
        ...
        "graph_trace_ids": {
            ...
            "items": {"type": "string"},
            "description": (
                "Explicit canonical graph-query trace ids for bypass continuation "
                "authority; never inferred from evidence_refs."
            ),
        },
        "task_id": {"type": "string"},
        "phase": {"type": "string"},
...
class ToolDispatcher:
    ...
    def dispatch(self, name: str, args: dict) -> Any:
        ...
        if name == "contract_update_start":
            ...
            return self._api("POST", f"/api/projects/{pid}/contract-update/start", body)
