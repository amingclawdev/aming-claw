...
CLI_AGENT_QA_BOOTSTRAP_GUIDE_PROMPT_TEMPLATE = (
    ...
    "2. Immediately call managed MCP `graph_query` with exactly these arguments: "
    ...
    "qa_session_token=<raw token from step 1>. Keep the returned trace_id. "
    ...
    "3. Only after graph_query returns a successful trace_id, call managed MCP "
    ...
    "not completion.\n"
    "4. Call managed MCP `contract_runtime_submit_line` for qa_graph_context. "
    ...
    "safe-copy fields.\n"
    "5. After qa_graph_context is accepted, re-read both managed MCP "
    ...
    "6. Record that refreshed revision, then call `contract_runtime_submit_line` "
    ...
    "failed.\n"
    "7. Re-read both managed MCP projections and require "
